...
const SignUp = () => {
  return (
    <div className="flex min-h-screen">
        ...
        <button className="bg-[#36925afb] text-white text-xl font-bold rounded-md p-2 w-[250px] h-[50px]">Sign Up</button>
          </Link>
        </div>
        </div>
    </div>
