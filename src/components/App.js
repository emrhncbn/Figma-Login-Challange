    ...
    return (
      <div className="flex min-h-screen">
          ...
          <input type="text"
           ...
           className="border-2 border-gray-500 rounded-md p-2 mb-7 w-[400px] h-[50px]"></input>
          <input type="password"
          ...
          <p>I agree <strong>Terms and Conditions & Private Policy</strong> by Signing in</p>
           </div>
          <div className="flex justify-center mt-10 w-[400px]">
            <Link to="/farmanalytics">
            <button className="bg-[#36925afb] text-white text-xl font-bold rounded-md p-2 w-[250px] h-[50px]">Log In</button>
            </Link>
            </div>
            <div className="flex justify-center mt-5 w-[400px]">
            <Link to="/signup">
            <button className="text-[#36925afb] border-2 border-[#36925afb] text-xl font-bold rounded-md p-2 w-[250px] h-[50px]">Sign Up</button>
            </Link>
          </div>
          </div>
      </div>
